...
This is the code repository for multimodal processing of Hindustani Raga music. The original data (audiovisual recordings) for this project is available on OSF at [Hindustani Vocal Audio Visual Correspondence](https://osf.io/qjkzs/). The OSF project has a component detailing the Ethical Use Declaration. 
